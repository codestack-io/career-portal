...
export default function Footer({ footer }) {
  // Navigation links configured with real page routes
  const quickLinks = [
    { name: "Home", href: "/" },
  ...
  // Default address search query if no specific maps link is provided in props
  ...
  return (
    <footer className="relative mt-32 overflow-visible rounded-t-[60px] bg-gradient-to-br from-slate-900 via-slate-950 to-violet-950 text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          {/* Brand & Short Description (Span 2 columns) */}
        ...
        <div className="border-t border-white/10 py-8">
          <div className="flex flex-col items-center justify-between gap-6 text-sm text-slate-400 md:flex-row">
            <p>
              ...
              <span className="font-semibold text-white">CareerHub</span>. All
              rights reserved.
            </p>
            ...
            <p>
              Designed with <span className="text-red-400">❤</span> for future
              global students.
            </p>
          </div>
        </div>
