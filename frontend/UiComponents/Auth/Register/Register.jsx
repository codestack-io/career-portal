...
console.log("Google backend status:", response.status);
console.log("Google backend response:", responseText);
...
try {
  ...
  setError(
    `Google authentication failed. Backend returned status ${response.status}.`
  );
