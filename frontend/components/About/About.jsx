  ...
  return (
    <section className="relative overflow-hidden py-28 bg-gradient-to-br from-slate-50 via-white to-violet-50">
      ...
      {/* Fades the image out toward the right/bottom so it blends into the
          section instead of showing a hard edge behind the content */}
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 bg-white rounded-3xl shadow-xl p-8">
              <h2 className="text-5xl font-bold text-violet-600">16+</h2>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-6 mt-16">
              <Stat
                ...
                inView={inView}
              />
              <Stat end={98} suffix="%" title="Visa Success Rate" inView={inView} />
              <Stat end={18} suffix="+" title="Study Destinations" inView={inView} />
              <Stat
...
function Stat({ end, suffix, title }) {
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
      ...
      <p className="mt-3 text-slate-500 font-medium">{title}</p>
    </div>
  );
}